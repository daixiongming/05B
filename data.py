...
class LlavaDataset(Dataset):
    ...
    '''
    #Xiongming Dai's change for the datasets that is supporting multiple dialogues, refer to Zero-Qwen
        conversations=cur_data.get("conversations")
        history=[]
...
if __name__ == "__main__":
    data_dir = "/home/xiongming/PythonProject5/liuhaotian/LLaVA-CC3M-Pretrain-595K"
