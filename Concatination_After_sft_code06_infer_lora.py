...
peft_model_name_or_path = "/home/xiongming/PycharmProjects/PythonProject1_Qwen15_05B_Chat/output_XiaYu_VL05B_model_freeze_vision_eyes"
model = LlavaForConditionalGeneration.from_pretrained(raw_model_name_or_path,device_map="cuda:0", torch_dtype=torch.bfloat16)
model = PeftModel.from_pretrained(model, peft_model_name_or_path, adapter_name="peft_v1",is_local=True)
...
#llavadataset = LlavaDataset("/home/xiongming/Documents/DATASETS/EYES/fundus_5990_split_resize/test/resized_images")
...
model.save_pretrained("output_XiaYu05B_VL_after_sft_model_lora_merge_001")
processor.save_pretrained("output_XiaYu05B_VL_after_sft_model_lora_merge_001")
